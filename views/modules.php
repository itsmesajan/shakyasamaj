...
$jVars['site:logo']			= '<a class="logo_box align-self-center" href="'.BASE_URL.'home"><img class="align-self-center" src="'.IMAGE_PATH.'preference/'.$siteRegulars->logo_upload.'" alt="logo" data-retina="true" /></a>';
