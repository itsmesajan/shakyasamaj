...
<div class="col-md-3" id="previewUserimage<?php echo $deleteid;?>">
    <div class="infobox info-bg">
        <img src="<?php echo IMAGE_PATH.'gallery/galleryimages/thumbnails/'.$val;?>"  style="width:100%"/>
        ...
        <input type="text" id="imgContent" name="imgContent[]" placeholder="imgContent" class="validate[length[0,350]]" style="padding: 0;">
    </div> 
</div>
...
//uplodify
  if(isset($_SESSION['imageNameArr'])){
   if(count($_SESSION['imageNameArr'])>0){
      ...
      { 
         @unlink(IMAGE_PATH.'gallery/galleryimages/thumbnails/'.$val);
      	 @unlink(IMAGE_PATH.'gallery/galleryimages/'.$val);
      }	 
