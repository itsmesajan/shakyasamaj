...
$countrys = array('India' => 'India', 'Nepal' => 'Nepal');
            ...
            <form action="" class="col-md-12 center-margin" id="package_frm">
                ...
                <div class="form-row menu-position">
                    ...
                    <div class="form-input col-md-3">
                        <select data-placeholder="None" class="chosen-select validate[]" id="country" name="country">
                            <option value="">Choose Country</option>
                            <?php foreach ($countrys as $key => $val) {
                                $sel = (!empty($packageInfo->country) and $packageInfo->country == $key) ? 'selected' : '';
