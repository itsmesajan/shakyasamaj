...
class Slideshow extends DatabaseObject
{
    ...
    protected static $db_fields = array('id', 'title', 'image', 'linksrc','source_vid','mode', 'linktype', 'content','class','host','url_type','thumb_image','url', 'status', 'm_status', 'added_date', 'sortorder', 'type', 'source');
    ...
    public static function getSlideshow_by($type = '',$limit='')
    {
        global $db;
    ...
    //Find all published rows in the current database table using mode. (image or video).
