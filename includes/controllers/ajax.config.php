<?php 
	...
	{		
		case "add":	
			...
			$record->event_upload		= $_REQUEST['imageArrayname20'];
			$record->notice_upload		= $_REQUEST['imageArrayname21'];
		...
		case "edit":
            ...
            $record->event_upload       = (!empty($_REQUEST['imageArrayname20'])) ? $_REQUEST['imageArrayname20'] : '';
            $record->notice_upload       = (!empty($_REQUEST['imageArrayname21'])) ? $_REQUEST['imageArrayname21'] : '';
