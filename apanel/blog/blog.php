...
?>
            ...
            <form action="" class="col-md-12 center-margin" id="blog_frm">
                ...
                <div class="form-row">
                    ...
                    <div class="form-input col-md-20">
                        <?php echo BASE_URL . 'blog/'; ?><input placeholder="Slug"
                                                      class="col-md-3 validate[required,length[0,200]]" type="text"
                                                      name="slug" id="slug"
                                                      value="<?php echo !empty($blogInfo->slug) ? $blogInfo->slug : ""; ?>">
                        <span id="error"></span>
                    </div>
                </div>
                <div class="form-row">
                            ...
                            <span class="float-left">
                                ...
                                ?>
                                    ...
                                    <a class="btn small float-right" href="javascript:void(0);"
                                       onclick="deleteSavedBlogimage(<?php echo $deleteId; ?>);">
                ...
                <div class="form-row">
                    ...
                    $deleteId = rand(1000, 9999);?>
                        <div class="col-md-3" id="removeSavedimg<?php echo $deleteId; ?>">
                            ...
                            <span class="float-left">
                                <?php
                                if (file_exists(SITE_ROOT . "images/blog/blogdetail/" . $blogInfo->b_image)):
                                    $filesize = filesize(SITE_ROOT . "images/blog/blogdetail/" . $blogInfo->b_image);
                                    echo 'Size : ' . getFileFormattedSize($filesize);
                                endif;
                                ?>
                            </span>
                                ...
                                <img src="<?php echo IMAGE_PATH . 'blog/blogdetail/thumbnails/' . $blogInfo->b_image; ?>"
                                     style="width:100%"/>
                            </div>
                        </div>
                    <?php endif; ?>
                    <div class="form-input col-md-10 uploader1">
                        <input type="file" name="gallery_upload1" id="gallery_upload1" class="transparent no-shadow">
                        <label>
                            <small>Image Dimensions (<?php echo Module::get_properties($moduleId, 'imgwidth'); ?> px
                                X <?php echo Module::get_properties($moduleId, 'imgheight'); ?> px)
                            </small>
                    ...
                    <!-- Upload user image preview -->
                    <div id="preview_Image1"><input type="hidden" name="imageArrayname1"
                                                   value="<?php echo !empty($blogInfo->b_image) ? $blogInfo->b_image : ""; ?>"
                                                   class=""/></div>
                </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#gallery_upload1').uploadify({
                'swf': '<?php echo ASSETS_PATH;?>uploadify/uploadify.swf',
                'uploader': '<?php echo ASSETS_PATH;?>uploadify/uploadify.php',
                'formData': {
                    PROJECT: '<?php echo SITE_FOLDER;?>',
                    targetFolder: 'images/blog/blogdetail/',
                    thumb_width: 200,
                    thumb_height: 200
                },
                'method': 'post',
                ...
                /* 'checkExisting' : '/uploadify/check-exists.php',*/
                'onUploadSuccess': function (file, data, response) {
                    $('#uploadedImageName1').val('1');
                    var filename = data;
                    $.post('<?php echo BASE_URL;?>apanel/blog/uploaded_image1.php', {imagefile: filename}, function (msg) {
                        $('#preview_Image1').html(msg).show();
                    });
