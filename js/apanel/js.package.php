<script language="javascript">
    ...
    /***************************************** Edit records *****************************************/
    function editRecord(Re) {
        window.location.href = "<?php echo ADMIN_URL?>subpackage/addEdit/" + Re;
    }


    /***************************************** View Subpackage Lists *******************************************/
    function viewSubpackagelist() {
        window.location.href = "<?php echo ADMIN_URL?>package/list/";
    }
    ...
    function AddNewSubpackage() {
        window.location.href = "<?php echo ADMIN_URL?>package/addEditsubpackage/";
    }
    ...
    //////////////////////
    function deleteSavedSubPackageimage(Re) {
        $('.MsgTitle').html('<?php echo sprintf($GLOBALS['basic']['deleteRecord_'], "image")?>');
        $('.pText').html('Click on yes button to delete this image permanently.!!');
        $('.divMessageBox').fadeIn();
        $('.MessageBoxContainer').fadeIn(1000);
