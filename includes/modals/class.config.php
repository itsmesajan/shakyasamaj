...
class Config extends DatabaseObject
{
    ...
    protected static $db_fields = array(
        'id', 'sitetitle', 'icon_upload', 'logo_upload', 'fb_upload', 'twitter_upload', 'gallery_upload', 'contact_upload', 'other_upload', 'facility_upload', 'offer_upload', 'event_upload','notice_upload',
        ...
        'pixel_code', 'whatsapp_a', 'whatsapp');
