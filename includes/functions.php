...
function get_front_pagination($total = '', $per_page = '2', $page = '1', $url = '')
{
    ...
    if ($lastpage > 1) {
        ...
        if ($page > 1)
            $pagination .= "<li class='page_list_item'><a href='" . $url . '/page/' . $prev . "' class='nav_page_link'><i class='ph-arrow-left'></i></a></li>";
        else
            $pagination .= "<li class='page_list_item disabled'><a href='javascript:void(0);' class='nav_page_link'><i class='ph-arrow-left'></i></a></li>";
        if ($lastpage < 7 + ($adjacents * 2)) {
            for ($counter = 1; $counter <= $lastpage; $counter++) {
                if ($counter == $page)
                    $pagination .= "<li class='page_list_item active'><a href='javascript:void(0);' class='nav_page_link'>$counter</a></li>";
                else
                    $pagination .= "<li class='page_list_item'><a href='" . $url . '/page/' . $counter . "' class='nav_page_link'>$counter</a></li>";
            }
        } elseif ($lastpage > 5 + ($adjacents * 2)) {
            if ($page < 1 + ($adjacents * 2)) {
                for ($counter = 1; $counter < 4 + ($adjacents * 2); $counter++) {
                    if ($counter == $page)
                        $pagination .= "<li class='page_list_item'><a href='javascript:void(0);' class='nav_page_link'>$counter</a></li>";
                    else
                        $pagination .= "<li class='page_list_item'><a href='" . $url . '/page/' . $counter . "' class='nav_page_link'>$counter</a></li>";
                }
                $pagination .= "<li class='page_list_item'><a>...</a></li>";
                $pagination .= "<li class='page_list_item'><a href='" . $url . '/page/' . $lpm1 . "' class='nav_page_link'>$lpm1</a></li>";
                $pagination .= "<li class='page_list_item'><a href='" . $url . '/page/' . $lastpage . "' class='nav_page_link'>$lastpage</a></li>";
            } elseif ($lastpage - ($adjacents * 2) > $page && $page > ($adjacents * 2)) {
                $pagination .= "<li class='page_list_item'><a href='" . $url . '/page/1' . "' class='nav_page_link'>1</a></li>";
                $pagination .= "<li class='page_list_item'><a href='" . $url . '/page/2' . "' class='nav_page_link'>2</a></li>";
                $pagination .= "<li class='page_list_item'><a>...</a></li>";
                ...
                $pagination .= "<li class='page_list_item'><a href='" . $url . '/page/1' . "' class='nav_page_link'>1</a></li>";
                $pagination .= "<li class='page_list_item'><a href='" . $url . '/page/2' . "' class='nav_page_link'>2</a></li>";
                $pagination .= "<li class='page_list_item'><a class='nav_page_link'>...</a></li>";
                for ($counter = $lastpage - (2 + ($adjacents * 2)); $counter <= $lastpage; $counter++) {
                    if ($counter == $page)
                        $pagination .= "<li class='page_list_item'><a class='nav_page_link'>$counter</a></li>";
                    else
                        $pagination .= "<li class='page_list_item'><a href='" . $url . '/page/' . $counter . "' class='nav_page_link'>$counter</a></li>";
                }
            }
        ...
        if ($page < $counter - 1)
            $pagination .= "<li class='page_list_item'><a href='" . $url . '/page/' . $next . "' class='nav_page_link'><i class='ph-arrow-right'></i></a></li>";
        else
            $pagination .= "<li class='page_list_item disabled'><a href='javascript:void(0);' class='nav_page_link'><i class='ph-arrow-right'></i></a></li>";
        $pagination .= "</ul>\n";
    }
