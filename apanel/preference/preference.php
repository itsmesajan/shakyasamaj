    ...
    <div class="example-code">
        <form action="" class="col-md-12 center-margin" id="Preference_frm">
            ...
            <div class="form-row">
                ...
                <?php if (!empty($PrefeRow->event_upload)): ?>
                    <div class="col-md-2" id="removeSavedimg20">
                        <div class="infobox info-bg">
                            <div class="button-group" data-toggle="buttons">
                                <span class="float-left">
                                    <?php
                                    if (file_exists(SITE_ROOT . "images/preference/events/" . $PrefeRow->event_upload)):
                                        $filesize = filesize(SITE_ROOT . "images/preference/events/" . $PrefeRow->event_upload);
                                        echo 'Size : ' . getFileFormattedSize($filesize);
                                    endif;
                                    ?>
                                </span>
                                <a class="btn small float-right" href="javascript:void(0);" onclick="deleteSavedPreferenceimage(20);">
                                    <i class="glyph-icon icon-trash-o"></i>
                                </a>
                            </div>
                            <img src="<?php echo IMAGE_PATH . 'preference/events/thumbnails/' . $PrefeRow->event_upload; ?>" style="width:100%"/>
                            <input type="hidden" name="imageArrayname20"
                                   value="<?php echo $PrefeRow->event_upload; ?>"/>
                        </div>
                    </div>
                <?php endif; ?>
                <div class="form-input col-md-10 uploader20 <?php echo !empty($PrefeRow->event_upload) ? "hide" : ""; ?>">
            ...
            <div class="form-row">
                ...
                <?php if (!empty($PrefeRow->notice_upload)): ?>
                    <div class="col-md-2" id="removeSavedimg21">
                        <div class="infobox info-bg">
                            <div class="button-group" data-toggle="buttons">
                                <span class="float-left">
                                    <?php
                                    if (file_exists(SITE_ROOT . "images/preference/notice/" . $PrefeRow->notice_upload)):
                                        $filesize = filesize(SITE_ROOT . "images/preference/notice/" . $PrefeRow->notice_upload);
                                        echo 'Size : ' . getFileFormattedSize($filesize);
                                    endif;
                                    ?>
                                </span>
                                <a class="btn small float-right" href="javascript:void(0);" onclick="deleteSavedPreferenceimage(21);">
                                    <i class="glyph-icon icon-trash-o"></i>
                                </a>
                            </div>
                            <img src="<?php echo IMAGE_PATH . 'preference/notice/thumbnails/' . $PrefeRow->notice_upload; ?>" style="width:100%"/>
                            <input type="hidden" name="imageArrayname21"
                                   value="<?php echo $PrefeRow->notice_upload; ?>"/>
                        </div>
                    </div>
                <?php endif; ?>
                <div class="form-input col-md-10 uploader21 <?php echo !empty($PrefeRow->notice_upload) ? "hide" : ""; ?>">
                    <input type="file" name="notice_upload" id="notice_upload" class="transparent no-shadow">
                    <label>
                        <small>Image Dimensions (<?php echo Module::get_properties($moduleId, 'ofimgwidth'); ?> px
                            X <?php echo Module::get_properties($moduleId, 'ofimgheight'); ?> px)
                        </small>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#event_upload').uploadify({
            ...
            'formData': {
                PROJECT: '<?php echo SITE_FOLDER;?>',
                targetFolder: 'images/preference/events/',
                thumb_width: 200,
                thumb_height: 200
            },
            'method': 'post',
            ...
            'onUploadSuccess': function (file, data, response) {
                var filename = data;
                $.post('<?php echo BASE_URL;?>apanel/preference/uploaded_event_image.php', {imagefile: filename}, function (msg) {
        ...
        $('#notice_upload').uploadify({
            'swf': '<?php echo ASSETS_PATH;?>uploadify/uploadify.swf',
            'uploader': '<?php echo ASSETS_PATH;?>uploadify/uploadify.php',
            'formData': {
                PROJECT: '<?php echo SITE_FOLDER;?>',
                targetFolder: 'images/preference/notice/',
                thumb_width: 200,
                thumb_height: 200
            },
            'method': 'post',
            ...
            'onUploadSuccess': function (file, data, response) {
                var filename = data;
                $.post('<?php echo BASE_URL;?>apanel/preference/uploaded_notice_image.php', {imagefile: filename}, function (msg) {
                    $('#preview_Image21').html(msg).show();
                });
